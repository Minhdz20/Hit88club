...
if (!Configs.Login.IsLogin) {
        ...
        actOpenFB() {
            cc.sys.openURL("");
            // App.instance.openWebView("");
        }

        actOpenMessager() {
            cc.sys.openURL("https://tables.kasoom.com/lobby/?IPAddress=171.237.98.80&language=VT&operatorid=32480&serverid=6401748&token=33-59cf86f7f70456d706f8896bd297ec26&selectedgame=Baccarat&isResponsive=True");
            // App.instance.openWebView("https://tables.kasoom.com/lobby/?IPAddress=171.237.98.80&language=VT&operatorid=32480&serverid=6401748&token=33-59cf86f7f70456d706f8896bd297ec26&selectedgame=Baccarat&isResponsive=True");
        }
        actOpenZalo() {
            cc.sys.openURL("");
        }
        actOpenLive() {
            App.instance.openWebView("https://t.me/CSKHFANVINVIP");
        }

        actOpenHotLine() {
            if (cc.sys.isNative) {
                cc.sys.openURL("tel:+639159922948");
            }
            else {
                App.instance.alertDialog.showMsg("Hotline : +639159922948 ");
            }
        }
        ...
        actSupportOnline() {
            ...
            if (!cc.sys.isNative) {
                var url = "https://t.me/CSKHFANVINVIP";
                cc.sys.openURL(url);
                //Tawk_API.toggle();
            }
            else {
