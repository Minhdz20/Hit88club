...
export default class Loading extends cc.Component {
    ...
    listTips = [
        ...
        {
            vi: "Nạp đầu nhận thưởng lên tới 680K",
            en: "First cash-in can receive bonus up to 680K"
        },
        {
        ...
        {
            vi: "JFun68 nạp rút nhanh chóng và an toàn!",
            en: "JFun68 quick cashin,cashout and alway safety!"
        },
    ]
    start() {
    ...
    startGame() {
        ...
        if (Configs.App.IS_LOCAL == false) {
            Http.get("https://res.bos7.net/assets/AssetBundleVersion.json", {}, (err, data) => {
