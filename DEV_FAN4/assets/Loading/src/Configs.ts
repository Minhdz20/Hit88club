...
namespace Configs {
    ...
    export class App {
        ...
        static API: string = "https://iportal.fanvin.vip/api";
		static API2: string = "https://iportal2.fanvin.vip/api";
		static APIROY: string = "https://portal.fanvin.vip/api";
        ...
        static readonly HOST_SOCKJS = "https://st.fanvin.vip/";
